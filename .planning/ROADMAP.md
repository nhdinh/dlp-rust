...
- [x] **Phase 25: App Identity Capture in dlp-user-ui** (complete 2026-04-22) -- Source and destination process identity resolved at clipboard time; Authenticode verification; audit event fields populated
...
**Plans**: 2 plans
Plans:
- [x] 27-01-PLAN.md -- UsbBlockResult struct + per-drive cooldown field + check() return type change + updated unit tests in usb_enforcer.rs
- [x] 27-02-PLAN.md -- Toast broadcast call site in interception/mod.rs run_event_loop (Pipe2AgentMsg::Toast wired after USB block)

...
async fn main() -> anyhow::Result<()> {
    ...
    let state = Arc::new(AppState {
        ...
        diagnostic_store: Some(Arc::new(
            dlp_server::diagnostic_store::DiagnosticSnapshotStore::new(),
        )),
        health_snapshot_store: Some(Arc::new(
            dlp_server::health_snapshot_store::HealthSnapshotStore::new(),
        )),
    });

...
mod file_ops_tc {
    ...
    fn test_tc_13_move_confidential_same_level_allowed() {
        let src = PolicyMapper::provisional_classification(r"C:\Confidential\folder_A\doc.docx");
        let dst = PolicyMapper::provisional_classification(r"C:\Confidential\folder_B\doc.docx");
        assert_eq!(src, Classification::T3);
    ...
    fn test_tc_60_confidential_save_as_allowed() {
        let new_path = PolicyMapper::provisional_classification(r"C:\Confidential\version2.xlsx");
    ...
    fn test_tc_61_confidential_overwrite_public_blocked() {
        let target = PolicyMapper::provisional_classification(r"C:\Public\readme.txt");
    ...
    fn test_tc_62_restricted_save_to_public_blocked() {
        let target = PolicyMapper::provisional_classification(r"C:\Public\upload\restricted.docx");
        assert_eq!(target, Classification::T1);

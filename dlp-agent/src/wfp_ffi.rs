...
pub use windows::Win32::NetworkManagement::WindowsFilteringPlatform::{
    ...
    FWPM_ACTION0, FWPM_ACTION0_0, FWPM_DISPLAY_DATA0, FWPM_FILTER0, FWPM_FILTER_CONDITION0,
    FWPM_FILTER_FLAGS, FWPM_LAYER_ALE_AUTH_CONNECT_V4, FWPM_SESSION0, FWPM_SUBLAYER0,
    FWP_ACTION_BLOCK, FWP_ACTION_TYPE, FWP_BYTE_BLOB, FWP_BYTE_BLOB_TYPE, FWP_CONDITION_VALUE0,
    FWP_CONDITION_VALUE0_0, FWP_DATA_TYPE, FWP_MATCH_EQUAL, FWP_MATCH_TYPE, FWP_UINT16, FWP_UINT8,
    FWP_VALUE0, FWP_VALUE0_0,
};

pub use windows::Win32::NetworkManagement::WindowsFilteringPlatform::{
    FWPM_CONDITION_ALE_APP_ID, FWPM_CONDITION_IP_PROTOCOL, FWPM_CONDITION_IP_REMOTE_PORT,
};

...
This project is indexed by GitNexus as **dlp-rust** (11087 symbols, 29556 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/dlp-rust/context` | Codebase overview, check index freshness |
| `gitnexus://repo/dlp-rust/clusters` | All functional areas |
| `gitnexus://repo/dlp-rust/processes` | All execution flows |
| `gitnexus://repo/dlp-rust/process/{name}` | Step-by-step execution trace |

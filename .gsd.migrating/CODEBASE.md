...
- `dlp-admin-cli/src/login.rs`
- `dlp-admin-cli/src/main.rs`
- `dlp-admin-cli/src/registry.rs`
- `dlp-admin-cli/src/tui.rs`
...
- `dlp-e2e/tests/agent_ui_lifecycle.rs`

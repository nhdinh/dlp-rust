...
- [ ] **T01: Add DiskRegistryList screen variant and InputPurpose variants** `est:20min`
...
- [ ] **T02: Implement load, delete, and add actions with dispatch handlers** `est:45min`
...
- [ ] **T03: Implement draw_disk_registry_list render function** `est:30min`
